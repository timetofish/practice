...
In fact, orch invokes an auto-generate "sai-redis" layer. For non-blocking method, orch doesn't get real return code from sai. The return code here is alway SAI_STATUS_SUCCESS.
...
7. After processing the received information, routeorch will invoke sairedis APIs to inject the route information into ASIC_DB. sairedis api are auto-generate at compiling time.
